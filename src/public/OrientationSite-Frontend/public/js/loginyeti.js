...
function getCoord(e) {
  ...
  window.TweenMax.to(eyeL, 1, {
    x: -eyeLX,
    y: -eyeLY,
    ease: window.Expo.easeOut
  });
  window.TweenMax.to(eyeR, 1, {
    x: -eyeRX,
    y: -eyeRY,
    ease: window.Expo.easeOut
  });
  window.TweenMax.to(nose, 1, {
    x: -noseX,
    y: -noseY,
    rotation: mouthR,
  ...
  window.TweenMax.to(chin, 1, {
    x: -chinX,
    y: -chinY,
    scaleY: chinS,
    ease: window.Expo.easeOut
  });
  window.TweenMax.to(face, 1, {
    x: -faceX,
    y: -faceY,
    skewX: -faceSkew,
  ...
  window.TweenMax.to(outerEarL, 1, {
    x: outerEarX,
    y: -outerEarY,
    ease: window.Expo.easeOut
  });
  window.TweenMax.to(outerEarR, 1, {
    x: outerEarX,
    y: outerEarY,
    ease: window.Expo.easeOut
  });
  window.TweenMax.to(earHairL, 1, {
    x: -outerEarX,
    y: -outerEarY,
    ease: window.Expo.easeOut
  });
  window.TweenMax.to(earHairR, 1, {
    x: -outerEarX,
    y: outerEarY,
    ease: window.Expo.easeOut
  });
  window.TweenMax.to(hair, 1, {
    x: hairX,
    scaleY: hairS,
...
function onEmailInput(e) {
  ...
  if (curEmailIndex > 0) {
    if (mouthStatus == "small") {
      ...
      window.TweenMax.to(tooth, 1, { x: 0, y: 0, ease: window.Expo.easeOut });
      window.TweenMax.to(tongue, 1, { x: 0, y: 1, ease: window.Expo.easeOut });
    ...
    if (value.includes("@")) {
      ...
      window.TweenMax.to(tooth, 1, { x: 3, y: -2, ease: window.Expo.easeOut });
      window.TweenMax.to(tongue, 1, { y: 2, ease: window.Expo.easeOut });
      window.TweenMax.to([eyeL, eyeR], 1, {
        scaleX: 0.65,
        scaleY: 0.65,
        ease: window.Expo.easeOut,
    ...
    window.TweenMax.to(tooth, 1, { x: 0, y: 0, ease: window.Expo.easeOut });
    window.TweenMax.to(tongue, 1, { y: 0, ease: window.Expo.easeOut });
    window.TweenMax.to([eyeL, eyeR], 1, {
      scaleX: 1,
      scaleY: 1,
      ease: window.Expo.easeOut
...
function coverEyes() {
  window.TweenMax.to(armL, 0.45, {
    x: -93,
    y: 2,
    rotation: 0,
    ease: Quad.easeOut
  });
  window.TweenMax.to(armR, 0.45, {
    x: -93,
    y: 2,
    rotation: 0,
    ease: Quad.easeOut,
...
function uncoverEyes() {
  window.TweenMax.to(armL, 1.35, { y: 220, ease: Quad.easeOut });
  window.TweenMax.to(armL, 1.35, {
    rotation: 105,
    ease: Quad.easeOut,
    delay: 0.1
  });
  window.TweenMax.to(armR, 1.35, { y: 220, ease: Quad.easeOut });
  window.TweenMax.to(armR, 1.35, {
    rotation: -105,
    ease: Quad.easeOut,
    delay: 0.1
  });
...
function resetFace() {
  ...
  window.TweenMax.to([face, eyebrow], 1, {
    x: 0,
    y: 0,
    skewX: 0,
    ease: window.Expo.easeOut
  });
  window.TweenMax.to([outerEarL, outerEarR, earHairL, earHairR, hair], 1, {
    x: 0,
    y: 0,
    scaleY: 1,
    ease: window.Expo.easeOut
